...
| 10 | `s10_fit_resolution.py` | 9 | `10_resolution_fits.csv`, `10_resolution_fits.root`, `10_resolution_fit.png`, `10_resolution_common.png` |

Stages 1, 3 and 6 read the events (RDataFrame, ~3 s per file). Everything else reads
CSV and takes seconds. The hodoscope pass runs 1, 2, 8, 9, 10: with the hodoscope there
is no position correction.
